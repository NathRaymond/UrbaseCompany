...
<div class="dashboard-panel">
                ...
                <div class="modal-content py-4 px-5">
                    ...
                    <div class="w-100 py-4">
                        <div class="profile-pic-change-parent d-flex justify-content-between">
                            <img style="border-radius: 130px; width:130px; height:130px" @if ($avatar=='' )
                                src="{{ asset('assets/img/company-profile-pic-modal.png') }}" @else src="{{ $avatar }}"
                                @endif alt="" class="img-fluid" id="bio-data-profile-image">
                            &nbsp;
                            <button class="profile-pic-upload-btn position-relative rounded"
                        ...
                        <div class="row w-100 my-4">
                            <div class=" col-md-6 d-flex flex-column">
                                ...
                                <input type="text" name="name" class="company-profile-bio-data w-100" placeholder=""
                                    value="{{ session()->get('user')['company'] }}" required>
                            </div>
                            <div class="col-md-6 d-flex flex-column">
                                ...
                                <select class="form-select company-profile-bio-data" name="industry"
                                    ...
                                    <option value="{{ $informations->industry ?? '' }}" selected>{{
                                        $informations->industry ?? '' }}</option>
                        ...
                        <div class="row w-100 mt-4">
                            <div class=" col-md-6 d-flex flex-column">
                                ...
                                <select class="form-select company-profile-bio-data" name="size"
                                    aria-label="Default select example" required>
                                    <option value="{{ $informations->size ?? '' }}" selected>{{ $informations->size ??
                                        '' }}</option>
                            ...
                            <div class="col-md-6 d-flex flex-column">
                                ...
                                <select class="form-select company-profile-bio-data" name="location"
                                    aria-label="Default select example" required>
                                    <option value="{{ $informations->location ?? '' }}" selected>{{
                                        $informations->location ?? '' }}</option>
        ...
        <div class="modal fade" id="editAboutCompany" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content py-4 px-5">
                    ...
                    <div>
                        <textarea class="form-control" name="about" rows="10" placeholder=""
                            required>{{ $abouts->about }}</textarea>
                    </div>
    ...
    <div class=" mt-4 p-5 company-profile-info-container rounded">
        <div class="company-profile-info d-flex justify-content-between">
            ...
            <div class="company-profile-info-edit-icon-conatiner d-flex flex-column align-items-center " role="button"
                data-bs-toggle="modal" data-bs-target="#editCompanyInfo">
        ...
        <div class="company-profile-info-details pt-4 px-5 w-100">
            <div class="company-profile-info-details-img">
                <img style="border-radius: 130px; width:150px; height:150px" @if ($avatar=='' )
                    src="{{ asset('assets/img/Profile-pic.png') }}" @else src="{{ $avatar }}" @endif alt=""
                    class="img-fluid" id="bio-data-profile-image">
            </div>
