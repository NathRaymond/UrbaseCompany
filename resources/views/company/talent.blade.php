...
<div class="dashboard-panel">
    ...
    <div class="modal fade" id="talentsAddUser" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    ...
                    <div class=" block bio-data-input-parent-container mx-0 mb-1 d-flex flex-column">
                        ...
                        <div
                            ...
                            <div class="talent-add-user-modal-input-container">
                                <input type="email" class="bio-data-name-input work-experience-textarea w-100" required>
                            </div>
                            <div class="talent-add-user-modal-delete-icon-container px-3 d-flex">
                                ...
                                <iconify-icon icon="akar-icons:plus" class="add fs-4 talent-add-user-modal-add-icon">
                                </iconify-icon>
                            </div>
                        </div>
                    </div>
                ...
                <div class="px-1 border-0">
                    <div class="image-upload-container position-relative">
                        ...
                        <div class="d-flex flex-column align-items-center">
                            <iconify-icon icon="material-symbols:drive-folder-upload" class="fs-2 csv-upload-icon"
                                role="button">
                            </iconify-icon>
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <div class="d-flex align-items-start justify-content-center flex-column">
                            <div class="company-talent-morale-level-heart-container ">
                                <iconify-icon icon="bi:heart-fill" class="company-talent-morale-level-heart me-1">
                                </iconify-icon>
                                <iconify-icon icon="bi:heart-fill" class="company-talent-morale-level-heart me-1">
                                </iconify-icon>
                                <iconify-icon icon="bi:heart-fill" class="company-talent-morale-level-heart me-1">
